...
\begin{minipage}{\columnwidth}
  \centering
  \includegraphics[width=\columnwidth]{rendija_todas.png}
  \captionof{figure}{Ajustes lineales de $P_n-P_{-n}$ frente a $n$ para las tres distancias de la rendija.}
  \label{fig:rendija_todas}
\end{minipage}
\vspace{4pt}
...
\begin{minipage}{\columnwidth}
  \centering
  \includegraphics[width=\columnwidth]{orificio_z1_circular.png}
  \captionof{figure}{Ajuste lineal de $P_n-P_{-n}$ frente a $\alpha_n$ para el orificio circular con $z_1=(2{,}935\pm0{,}005)$ m.}
  \label{fig:orificio_z1}
\end{minipage}
\vspace{4pt}
...
\begin{minipage}{\columnwidth}
  \centering
  \includegraphics[width=\columnwidth]{babinet.png}
  \captionof{figure}{Patrón de difracción observado para la comparación con el principio de Babinet.}
  \label{fig:babinet}
\end{minipage}
\vspace{4pt}

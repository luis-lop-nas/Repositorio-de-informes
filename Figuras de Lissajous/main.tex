...
Las figuras de la Tabla~\ref{tab:lissajous} corresponden correctamente a las relaciones ajustadas. Para cada relación se obtuvieron dos formas distintas variando el desfase relativo, en acuerdo con las formas teóricas esperadas para cada razón de frecuencias.
...
\toprule
 & $1{:}1$ & $1{:}2$ & $1{:}3$ & $2{:}3$ \\
\midrule
Vista & \includegraphics[width=3cm]{imagenes/liss_1_1.jpeg}
